...
- (void)initExampleData {
    ...
    self.sectionNames = @[@"Energy",@"Identification",@"Barcodes",@"Fintech",@"Document",@"Loyality",@"Other"];
    self.examples = @{self.sectionNames[0] : @[electricScanning,gasScanning,heatScanning,digitalScanning,waterScanning],
                      ...
                      self.sectionNames[6] : @[licensePlateScanning,scrabbleScanning,isbnScanning,recordScanning],
                      };
}
